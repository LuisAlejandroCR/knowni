...
export default function Espacio() {
  ...
  return (
    <Screen>
      <TopBar title="Mi espacio" right={<Text onPress={() => router.back()}>Cerrar</Text>} />
      <ScrollView contentContainerStyle={{ paddingHorizontal: 24 }}>
        ...
        <Label>Emisor</Label>
        <Row title={flow.issuer?.issuerId ?? "Sin conectar"} scope={ISSUER_URL} />
      ...
      <DemoStamp>ESTADO REAL DE ESTA SESIÓN</DemoStamp>
    </Screen>
  );
}
