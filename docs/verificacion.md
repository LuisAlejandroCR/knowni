...
| La plantilla llana deja de gastar señales en sumar la constante de ronda y en copiar celdas en las rondas parciales | ⏳ pendiente de medir: las no lineales no cambian por construcción (mismas multiplicaciones), y las lineales bajan. La cifra se anota cuando CI la imprima — D-62 | — |
