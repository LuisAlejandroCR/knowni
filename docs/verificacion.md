...
| Cómo se comprueba la autenticidad del Estado Único de Cuenta de UGPP —firma electrónica, QR o código contra la fuente— | **Sin verificar.** El adaptador ya exige la comprobación y refuse sin ella | 2026-09-21 | ⏳ **Bloquea** encender el camino documental |
